	 ...
	 <div class="container">
		 ...
		 <div class="about-grids">
		 	<div class="col-md-5 about-pic">
				 <img src="images/${grogshop.img1 }" class="img-responsive" alt=""/>
			 </div>
			 <div class="col-md-7 about-list">
				 <div class="about-top-sec">
				 	<h3>${grogshop.name }</h3>
				 	<h4>地址：</h4>
				 	<p>${grogshop.address }</p>
				 	<h4>价格：${grogshop.price }</h4>
					 <c:if test="${userSession!=null}">
					 <button type="button" class="btn btn-default" data-toggle="modal" data-target="#addscenModal">酒店预订</button>
			 		</c:if>	
		 ...
		 <div class="about-top-sec">
					 <h4>酒店介绍：</h4>
					 <c:if test="${not empty grogshop.img2}">
					 <div class="center-block" style="width:700px">
			  			<img src="images/${grogshop.img2 }" class="img-responsive" alt=""/>
			 		 </div>
			 		 </c:if>
			 		 <div style="margin:5px;"></div>
			 		 <c:if test="${not empty grogshop.img3}">
					 <div class="center-block" style="width:700px">
			  			<img src="images/${grogshop.img3 }" class="img-responsive" alt=""/>
			 		 </div>
			 		 </c:if>
					 <p>${grogshop.intro }</p>	
            ...
            <form role="form" class="form-horizontal" id="addscenform"  method="post" action="${pageContext.request.contextPath }/buyticket/add">
                <div class="modal-body">
                	<div class="form-group">
                        <label class="col-sm-2 control-label">预定天数</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
 					...
 					<input type="hidden" class="form-control" name="sid" value="${grogshop.name }" required/>
 					<input type="hidden" class="form-control" name="fenlei" value="酒店" required/>
                </div>
...
jQuery("#num").bind("blur",function(){
	...
	if(!isNaN(num)){
		jQuery("#price").val(num*${grogshop.price });
	}
}).focus();
...
<script type="text/javascript">
  ...
  var point=new BMap.Point(${grogshop.coordinate});
