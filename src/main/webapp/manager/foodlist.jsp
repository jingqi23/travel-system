                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <form action="${pageContext.request.contextPath }/food/query1" method="post">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div id="dataTables-example_filter" class="dataTables_filter">
                                            <label>名称:<input type="search" class="form-control input-sm-8"
                                                             aria-controls="dataTables-example" name="queryFoodName" value="${queryFoodName }">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tr class="gradeA odd">
                                        ...
                                        <td class=" ">${food.price }元</td>
                                        <td class=" ">${food.address }</td>
                                        <td class="center ">
                                            <button type="button" class="btn btn-info" onclick="updatebyid(${food.id})" data-toggle="modal" data-target="#updateModal"><span
                                                    class="glyphicon glyphicon-edit"></span> 修改
                                            </button>
                                            <button type="button" onclick="doDel(${food.id})" class="btn btn-danger"><span
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">美食增加</h4>
            </div>
            <form role="form" id="addform" class="form-horizontal" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/food/add">
            	<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">美食简介:</label>
                        <div class="col-sm-8">	
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="updateModalLabel">美食修改</h4>
            </div>
            <form role="form" id="updateform" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/food/modifyexe">
...
$.ajax({
	type:"post",//请求类型
	url:"${pageContext.request.contextPath }/food/modify",//请求的url
	data:{id:id},//请求参数
...
function doDel(id){
	 if(confirm("是否删除?")){
	 	location.href="${pageContext.request.contextPath }/food/del/"+id;
	 }
}
</script>
