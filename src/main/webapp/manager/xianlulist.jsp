                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <form action="${pageContext.request.contextPath }/xianlu/query1" method="post">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div id="dataTables-example_filter" class="dataTables_filter">
                                            <label>名称:<input type="search" class="form-control input-sm-8"
                                                             aria-controls="dataTables-example" name="queryXianluName" value="${queryXianluName }">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                    ...
                                    <tbody>
                                    <c:forEach var="xianlu" items="${xianluList }" varStatus="status">
                                    <tr class="gradeA odd">
                                        <td class="sorting_1">${status.count }</td>
                                        <td class=" ">${xianlu.name }</td>
                                        <td class="center ">${xianlu.price }元</td>
                                        <td class=" ">${xianlu.tnum }</td>
                                        <td class="center ">
                                            <button type="button" class="btn btn-info" onclick="updatebyid(${xianlu.id})" data-toggle="modal" data-target="#updateModal"><span
                                                    class="glyphicon glyphicon-edit"></span> 修改
                                            </button>
                                            <button type="button" onclick="doDel(${xianlu.id})" class="btn btn-danger"><span
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" id="addform" class="form-horizontal" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/xianlu/add">
            	<div class="modal-body">
 				...
 				<div class="form-group">
                        <label class="col-sm-2 control-label">余票:</label>
                        <div class="col-sm-8">
                         <input class="form-control" id="addtnum" name="tnum"/>
                        </div>
                        <span class="col-sm-1" style="color: red;">*</span>
                    </div>
                   
                    <div class="form-group">
                        <label class="col-sm-2 control-label">线路简介:</label>
                        <div class="col-sm-8">	
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" id="updateform" class="form-horizontal" method="post" action="${pageContext.request.contextPath }/xianlu/modifyexe">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">余票:</label>
                        <div class="col-sm-8">
                         <input class="form-control" id="updatetnum" name="tnum"/>
                        </div>
                        <span class="col-sm-1" style="color: red;">*</span>
                    </div>
                    <div class="form-group">
...
$.ajax({
	type:"post",//请求类型
	url:"${pageContext.request.contextPath }/xianlu/modify",//请求的url
	data:{id:id},//请求参数
...
function doDel(id){
	 if(confirm("是否删除?")){
	 	location.href="${pageContext.request.contextPath }/xianlu/del/"+id;
	 }
}
</script>
