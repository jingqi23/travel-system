	  ...
	  <div class="content white ">
		...
		<div style="line-height:56px;"> 
						<c:if test="${userSession==null}">
						  	<button type="button" class="btn btn-default" data-toggle="modal" data-target="#loganModal"> 登4录</button>
                         	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal" >注1册</button>
                    ...
                    <h4  style="display:none;">今日流量:<span id="liuliang" style="color:#5cb85c"></span></h4>
                </div>
		  <!--/navbar-->		 
	  </div>
...
--%><div class="modal fade" id="loganModal" tabindex="-1" role="dialog" aria-labelledby="liganModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="liganModalLabel">用户登录a</h4>
            </div>
            <form role="form" class="form-horizontal"   method="post" action="${pageContext.request.contextPath }/userold/login">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="submit" class="btn btn-primary">登2录</button>
                </div>
            </form>
        </div>
    </div>
...
修改
 ...
 $(function(){
	 //$.getJSON("${pageContext.request.contextPath }/buyticket/query_a",function(data){$("#liuliang").html(data)});
	 });
